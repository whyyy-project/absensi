...
<body>
            ...
            <div class="container-fluid">
                <nav class="navbar navbar-expand-lg custom_nav-container">
                    <a class="navbar-brand" href="/">
                        <img loading="lazy" src="public/assets/images/logo.png" alt="" />
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="user_option">
                            <a href="login">
                                <img loading="lazy" src="public/assets/images/user.png" alt="">
                                <span>
                                    Login
                                </span>
                            </a>
                    ...
                    <div class="col-md-6">
                        <div class="detail-box">
                            <div class="heading_container">
                                <h2>
                                    Murid Paling Desiplin Mingguan
                                </h2>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="collapse show" id="collapseOne" aria-labelledby="headingOne"
                            ...
                            <div class="img_container ">
                                <div class="box b-1">
                                    <div class="img-box">
                                        <img loading="lazy" src="public/images/contoh.jpeg" alt="">
                                    </div>
                                    <div class="img-box">
                                        <img loading="lazy" src="public/images/contoh.jpeg" alt="">
                                    </div>
    ...
    <section class="info_section layout_padding2">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="info_contact" id="tentang">
                        <h5>
                            Tentang Kami
                        </h5>
                        <div>
